import { LogBox, SafeAreaView, ScrollView, ActivityIndicator,BackHandler, StyleSheet, Text, TextInput, TouchableOpacity, View, Image, Platform, PermissionsAndroid } from 'react-native';
        ...
        <SafeAreaView>
            < View style={styles.container}>
                ...
                <View style={styles.inputContainer}>
                    <Text style={{ fontSize: hp('2.3%'), fontWeight: "normal", marginLeft: wp('1.5%'),color:'#000' }}>Patient Details</Text>
                ...
                <View style={{ bottom: 0, }}>
                    ...
                    >
                        ...
                        <View style={{ width: wp('88%'), height: hp('57%'),alignSelf: "center", alignItems: 'center', justifyContent: 'center' }}>
                                <TouchableOpacity style={{ alignSelf: 'flex-end',marginRight:wp('2%')}} onPress={() => setThankYou(false)}>
